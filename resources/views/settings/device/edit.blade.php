...
<div class="col-md-7">
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('devices.update', ['device' => $device->id]) }}" method="POST" class="form-horizontal">
            @method('PATCH')
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="code" name="code" value="{{ old('code') ?? $device->code }}"
                            placeholder="Code">
                        @error('code')
